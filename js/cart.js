...
async function user_cart() {
  ...
  await ajax_fetch("add_cart.php", 1, "get",ope2);
...
async function add_basket(element){
    ...
    await ajax_fetch("add_cart.php", "id" , "get", getUserId );

    if(userId){
        await ajax_fetch("add_cart.php", {id:productID}, "post", addToCart);
    }
}
